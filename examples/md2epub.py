...
Throughout this script, the abbreviation AST for Abstract Syntax Tree is
used.
"""
...
def transform_ast(ast):
    ...
    with gleetex.htmlhandling.HtmlImageFormatter('.') as img_fmt:
        ...
        gleetex.pandoc.replace_formulas_in_ast(
            img_fmt, ast['blocks'], formulas)
...
def main():
    ...
    proc = subprocess.Popen(
        ['pandoc', '-t', 'json', inputfile], stdout=subprocess.PIPE)
